...
#        endif
        ...
        protected GameObject[] GetGameObjectsWithTagInBounds(string searchTag, Bounds bounds) {
            ...
            foreach (GameObject obstruction in obstructionsTemp) {
                ...
                if (obstructionCollider != null && bounds.Intersects(obstructionCollider.bounds)) {
		...
		protected void CreatePlaneCollider() {
            ...
            if (planeColliderObject == null) {
				...
				planeColliderObject.transform.localScale = new Vector3 (1f, 1f, 1f);;
            }
        ...
        private void UpdateProperties() {
            ...
            if (Application.isPlaying && UsePlaneCollider) {
				...
				//ShowClientChooseMap l = (ShowClientChooseMap) go.GetComponent(typeof(ShowClientChooseMap));
				CreatePlaneCollider();
            }
        ...
        private void OnDrawGizmos() {
            ...
            Gizmos.DrawIcon(new Vector3(collider.bounds.center.x, transform.position.y + 0.1f, collider.bounds.center.z), "DynamicWater/FluidVolume.png");
